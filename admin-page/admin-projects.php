...
<div class="main">
    <div class="container-fluid mb-5" style="background-color: #3f7652">     
        <h1 class="display-4 fw-bold p-3 text-center text-white">BARANGAY PROJECTS</h1>
    </div>

    <div class="container mb-4">
        <button type="button" class="btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#exampleModal">New Project</button>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        ...
                        <div class="mb-5">
                            <label class="form-label" for="customFile">Featured:</label>
