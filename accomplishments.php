...
<section class="history-section">
    <div class="container-fluid" style="background-color: #3f7652">     
        <h1 class="display-3 fw-bold p-4 text-center text-white">ACCOMPLISHMENTS</h1>
    </div>
    ...
    <div class="container p-4 mb-5" id="p1">
        <div class="row flex-row-reverse g-5 align-items-center">
            ...
            <div class="col-lg-6">
                <img src="assets/projects/project-1.jpg" class="img-fluid shadow-lg p-3 bg-body rounded" alt="Barangay Image">
            </div>
        </div>
    </div>
</section>